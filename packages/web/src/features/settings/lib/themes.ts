...
export function resolveTheme(variant: ThemeVariant) {
  ...
  return {
    surface: dark ? "#000000" : surface,
    "surface-deep": dark ? "#000000" : surfaceDeep,
    "surface-raised": dark ? "#000000" : surfaceRaised,
    "surface-control": dark ? "#000000" : surfaceControl,
    "surface-sidebar": dark ? "#000000" : surfaceSidebar,
    "surface-sidebar-translucent": dark ? "#000000" : surfaceSidebarTranslucent,
    "surface-recessed": dark ? "#000000" : surfaceRecessed,
    "surface-popover": dark ? "#000000" : surfacePopover,
    "surface-drawer": dark ? "#000000" : surfaceDrawer,
    "surface-elevated-secondary": dark ? "#000000" : surfaceElevatedSecondary,
    ink,
    "ink-strong": ink,
    "ink-muted": dark ? ink : alpha(ink, textSecondaryOpacity),
    "ink-faint": dark ? ink : alpha(ink, textTertiaryOpacity),
    "ink-inverse": surface,
    border: alpha(ink, borderOpacity),
    "border-muted": alpha(ink, borderMutedOpacity),
    "border-strong": alpha(ink, borderStrongOpacity),
    "overlay-hover": dark ? "transparent" : alpha(ink, overlayHoverOpacity),
    "overlay-pressed": dark ? "transparent" : alpha(ink, overlayPressedOpacity),
    "overlay-strong": dark ? "transparent" : alpha(ink, overlayStrongOpacity),
